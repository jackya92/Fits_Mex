...
INSERT INTO `musculo` (`id_musculo`, `nom_musculo`, `grupo_muscular`, `img_musculo`) VALUES
(1, 'Bíceps Braquial', 'Extremidad Superior (Brazo)', 'biceps_braquial.png'),
(2, 'Tríceps Braquial', 'Extremidad Superior (Brazo)', 'triceps_braquial.png'),
(3, 'Deltoides', 'Hombro', 'deltoides.png'),
(4, 'Pectoral Mayor', 'Tronco (Pecho)', 'pectoral_mayor.png'),
(5, 'Dorsal Ancho', 'Tronco (Espalda)', 'dorsal_ancho.png'),
(6, 'Trapecio', 'Tronco (Espalda)', 'trapecio.png'),
(7, 'Recto Abdominal', 'Tronco (Abdomen)', 'recto_abdominal.png'),
(8, 'Glúteo Mayor', 'Extremidad Inferior (Cadera/Na', 'gluteo_mayor.png'),
(9, 'Cuádriceps Femoral', 'Extremidad Inferior (Muslo)', 'cuadriceps_femoral.png'),
(10, 'Isquiotibiales', 'Extremidad Inferior (Muslo)', 'isquiotibiales.png'),
(11, 'Gemelos (Gastrocnemio)', 'Extremidad Inferior (Pierna)', 'gemelos.png'),
(12, 'Tibial Anterior', 'Extremidad Inferior (Pierna)', 'tibial_anterior.png');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `rel_ejer_musc`
--

CREATE TABLE `rel_ejer_musc` (
  `id_ejercicio` int(11) NOT NULL,
  `id_musculo` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `rel_ejer_musc`
--

INSERT INTO `rel_ejer_musc` (`id_ejercicio`, `id_musculo`) VALUES
(1, 8),
(1, 9),
(2, 4),
(2, 8),
...
--
-- Indices de la tabla `rel_ejer_musc`
--
ALTER TABLE `rel_ejer_musc`
...
--
ALTER TABLE `musculo`
  MODIFY `id_musculo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- Filtros para la tabla `rel_ejer_musc`
--
ALTER TABLE `rel_ejer_musc`
  ADD CONSTRAINT `rel_ejer_musc_ibfk_1` FOREIGN KEY (`id_ejercicio`) REFERENCES `ejercicio` (`id_ejercicio`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `rel_ejer_musc_ibfk_2` FOREIGN KEY (`id_musculo`) REFERENCES `musculo` (`id_musculo`) ON DELETE CASCADE ON UPDATE CASCADE;
